...
class SpeciesScreenUI extends StatelessWidget {
  ...
  const SpeciesScreenUI({
    ...
    required this.bannedSpecies,
    required this.activeSpecies,
    required this.onSearchChanged,
    required this.onBannedFilterChanged,
  ...
  Widget _filterBar() {
    final bannedValue = bannedFilter == null
        ? 'All'
        : (bannedFilter! ? 'Banned' : 'Not Banned');
    final activeValue =
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: _statCard('Total Species', '$totalSpecies',
                    Icons.set_meal_rounded, _accent),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: _statCard('Banned', '$bannedSpecies',
                    Icons.block_rounded, _red),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: _statCard('Active', '$activeSpecies',
          ...
          Wrap(
            ...
            children: [
              ...
              SizedBox(
                  width: 150,
                  child: _dropdown('BANNED', bannedValue,
                      ['All', 'Banned', 'Not Banned'], onBannedFilterChanged)),
              SizedBox(
                  width: 150,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child:
                const Icon(Icons.set_meal_outlined, color: _accent, size: 26),
          ),
          const SizedBox(height: 16),
              ...
              return Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                        flex: 2,
                        child: Center(child: _badge(banned, true))),
                    Expanded(
                        flex: 2,
                        child: Center(child: _badge(active, false))),
                  ],
                ),
              );
            },
  ...
  Widget _badge(bool value, bool isBanned) {
    Color c;
    if (isBanned) {
      c = value ? _red : _green;
    } else {
